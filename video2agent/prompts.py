...
When providing the answer, include timestamps from the transcript snippets to indicate where the information was found.
...
Timestamps: <List of timestamps from the transcript snippets>
"""
